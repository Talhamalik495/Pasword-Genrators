  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-5 justify-center items-center">
        ...
        <div className="text-black max-w-xl mx-auto bg-white shadow-lg shadow-black flex px-8 py-10 flex-col rounded-lg  gap-5">
          <div className="flex justify-center align-middle gap-2">
            <input
              className="w-full  text-black  bg-white  h-10 px-2 border-[1px] border-black rounded-lg"
              type="text "
              placeholder="password"
              readOnly
              value={Password}
            />
            <button className="w-40 h-10 rounded-md  bg-blue-400 text-black">
              Copy
            </button>
          </div>
